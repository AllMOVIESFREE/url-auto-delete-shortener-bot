...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6424894431').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002343471138')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002418448105')).split()]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'b94cfe33d707743b52c7b3e340196402ca2bb45c')
...
CAPTION_BUTTON_URL = "https://youtube.com/@moviesprimehub_updates"
